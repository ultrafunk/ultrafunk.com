...
const playbackSettingsSchema = {
  ...
  trackCrossfade:        { description: 'Track Crossfade',                 values: [true, false],           default: true,  valueStrings: ['ON', 'OFF'] },
  trackCrossfadeLength:  { description: 'Track Crossfade Length',          values: [5, 10, 15, 20, 25, 30], default: 10,    valueStrings: ['5 sec', '10 sec', '15 sec', '20 sec', '25 sec', '30 sec'] },
  trackCrossfadeCurve:   { description: 'Track Crossfade Curve',           values: [0, 1],                  default: 0,     valueStrings: ['EQUAL POWER', 'LINEAR'] },
