...
import * as debugLogger from './debuglogger.js?ver=1.17.8';
import * as settings    from './settings.js?ver=1.17.8';
import { showSnackbar } from './snackbar.js?ver=1.17.8';
...
import {
  ...
  readJson,
  writeJson,
} from '../shared/storage.js?ver=1.17.8';
