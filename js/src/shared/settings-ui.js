...
import * as debugLogger from './debuglogger.js?ver=1.18.0';
import * as settings    from './settings.js?ver=1.18.0';
import { showSnackbar } from './snackbar.js?ver=1.18.0';
...
import {
  ...
  readJson,
  writeJson,
} from '../shared/storage.js?ver=1.18.0';
